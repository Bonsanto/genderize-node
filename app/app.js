...
var http = require("request"), fs = require("fs");
 ...
 * */
var readCSVFile = function (sourcePath, fixerFunctions, encode, columnSeparator, rowSeparator) {
...
var writeCSV = function (path, dataSet, columnSeparator, rowSeparator) {
    if (columnSeparator === void 0) { columnSeparator = ","; }
    if (rowSeparator === void 0) { rowSeparator = "\n"; }
